...
class Admin implements Registrable {
	...
	public function add_admin_menu(): void {
		add_menu_page(
			__( 'ScreenOptions', 'screen-options' ),
			__( 'ScreenOptions', 'screen-options' ),
			'manage_options',
			self::MENU_SLUG,
			'__return_null',
	...
	public function screen_callback(): void {
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'Settings', 'screen-options' ); ?></h1>
			<div id="screen-options-settings-page"></div>
		</div>
		<?php
	}
	...
	public function inject_site_selection_modal(): void {
		...
		?>
		<div class="wrap">
			<div id="screen-options-site-selection-modal" class="screen-options-modal"></div>
		</div>
		<?php
	}
	...
	private function add_body_class_for_modal( string $classes ): string {
		...
		// Add screen-options-site-selection-modal class to body.
		$classes .= ' screen-options-site-selection-modal ';
		return $classes;
	}
	...
	private function add_body_class_for_missing_sites( string $classes ): string {
		...
		$classes .= ' screen-options-missing-brand-sites ';
		return $classes;
	}
