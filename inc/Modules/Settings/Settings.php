	...
	public function register_settings(): void {
		$shared_settings = [
			self::OPTION_SITE_TYPE => [
				'type'              => 'string',
				'label'             => __( 'Site Type', 'screen-options' ),
				'description'       => __( 'Defines whether this site is a governing or a brand site.', 'screen-options' ),
		...
		$consumer_settings = [
			self::OPTION_CONSUMER_API_KEY         => [
				'type'              => 'string',
				'label'             => __( 'Consumer API Key', 'screen-options' ),
				'description'       => __( 'API key used by governing site to authenticate requests from this consumer site.', 'screen-options' ),
			...
			self::OPTION_CONSUMER_PARENT_SITE_URL => [
				'type'              => 'string',
				'label'             => __( 'Parent Site URL', 'screen-options' ),
				'description'       => __( 'The URL of the governing site that manages this consumer site.', 'screen-options' ),
		...
		$governing_settings = [
			self::OPTION_GOVERNING_SHARED_SITES => [
				'type'              => 'array',
				'label'             => __( 'Brand Sites', 'screen-options' ),
				'description'       => __( 'An array of brand sites connected to this governing site.', 'screen-options' ),
