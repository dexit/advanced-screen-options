		...
		foreach ( $hooks as $hook ) {
			add_action(
				...
				static function (): void {
					$error_message = __( 'ScreenOptions: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'screen-options' );
