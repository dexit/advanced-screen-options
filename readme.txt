...
Advanced Screen Options solves this by providing centralized configuration of screen options, allowing you to set defaults once for all users or configure different settings for different user roles.
...
* Columns that are added by third-party plugins may be registered conditionally and may not appear in the Advanced Screen Options settings if those plugins are not active or their conditions are not met. (eg: Yoast SEO columns appear only when meta boxes are enabled in the Yoast settings)
...
1. Upload the Advanced Screen Options plugin files to the `/wp-content/plugins/advanced-screen-options` directory, or install the plugin through the WordPress plugins screen directly
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Navigate to "Advanced Screen Options" in your WordPress admin menu
...
For detailed installation and configuration instructions, see the [Installation Guide](https://github.com/rtCamp/advanced-screen-options/blob/main/docs/INSTALLATION.md).

== Frequently Asked Questions ==

= How do I set default screen options? =

Navigate to "Advanced Screen Options" in your admin menu, create a new entry, select the post type or screen, choose your desired columns and options, then publish.
...
Navigate to "Advanced Screen Options", find the configuration you want to remove, and delete it like you would delete any post.
...
1. Advanced Screen Options admin menu.
