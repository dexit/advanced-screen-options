...
If you find a bug or have a feature request, please open an issue in the [GitHub Issues](https://github.com/rtCamp/screen-options/issues) section. Provide as much detail as possible, including:
...
> [!TIP]
>
> **Note**: Before opening a new issue, please search the [GitHub Issues](https://github.com/rtCamp/screen-options/issues) to see if a similar issue has already been reported.
>
