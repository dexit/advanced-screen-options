# Contributing to the Screen Options

Thank you for considering contributing to Screen Options! We appreciate your help in improving this open-source project.
...
If you find a bug or have a feature request, please open an issue in the [GitHub Issues](https://github.com/rtCamp/advanced-screen-options/issues) section. Provide as much detail as possible, including:
...
> [!TIP]
>
> **Note**: Before opening a new issue, please search the [GitHub Issues](https://github.com/rtCamp/advanced-screen-options/issues) to see if a similar issue has already been reported.
>
...
We appreciate your time and contributions to the `Screen Options` project. Your efforts help make this project better for everyone!
To contribute:
