# Security Policy for `Screen Options`
...
If you discover any security vulnerability in **`Screen Options`**, please follow these steps:
...
Thank you for helping us keep `Screen Options` secure!
